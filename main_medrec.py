...
parser.add_argument(
    "--demo", default=False, action="store_true", help="whether run demo"
)
parser.add_argument(
    "--train_file", default="1128", type=str, required=False, help="training data file."
)
parser.add_argument(
    "--filter",
    default=False,
...
parser.add_argument(
    "--Test", default=False, action="store_true", help="whether only run the test"
)
...
parser.add_argument(
    "--graph", default=False, action="store_true", help="if use ontology embedding"
)
...
parser.add_argument(
    "--max_record_num", default=10, type=int, help="The maximum record number."
)
parser.add_argument(
...
parser.add_argument("--l2", default=0, type=float, help="The L2 regularization")
parser.add_argument(
    "--num_train_epochs",
    default=30,
    type=float,
...
parser.add_argument(
    "--lr_dc_step", default=1000, type=int, help="every n step, decrease the lr"
)
parser.add_argument(
    "--lr_dc", default=0, type=float, help="how many learning rate to decrease"
)
parser.add_argument(
    "--patience",
    type=int,
...
parser.add_argument(
    "--seed", type=int, default=42, help="random seed for different data split"
)
parser.add_argument(
    "--warmup_proportion",
    default=0.1,
...
parser.add_argument("--gpu_id", default=0, type=int, help="The device id.")
parser.add_argument(
    "--num_workers", default=0, type=int, help="The number of workers in dataloader"
)
parser.add_argument(
    "--log", default=False, action="store_true", help="whether create a new log file"
)
parser.add_argument(
    "--out_file",
    default="none",
...
parser.add_argument(
    "--num_trm_layers", default=1, type=int, help="the number of trm layers"
)
...
parser.add_argument(
    "--alpha", default=0.1, type=float, help="The weight to adjust distillation loss."
)
parser.add_argument(
    "--medrec_path",
...
parser.add_argument(
    "--prompt_num", default=1, type=int, help="The number of prompt embeddings."
)
parser.add_argument(
    "--d_loss",
    type=str,
...
parser.add_argument(
    "--temperature", default=5, type=float, help="The temperature for distillation"
)
parser.add_argument(
    "--ddi", default=False, action="store_true", help="whether adopt the ddi loss"
)
parser.add_argument("--target_ddi", default=0.06, type=float, help="target ddi rate")
parser.add_argument(
    "--ddi_temp", default=2.0, type=float, help="the temperature for ddi update"
)
parser.add_argument(
    "--ml_weight", default=0.05, type=float, help="the weight of multi-label loss"
)
parser.add_argument(
    "--ddi_constraint",
    default=False,
    action="store_true",
    help="whether apply DDI constraints at inference (post-processing)",
)
parser.add_argument(
    "--align",
    default=False,
...
parser.add_argument(
    "--align_weight", default=0.1, type=float, help="the weight for alignment loss"
)
...
def main():
    ...
    if not args.Test:
        ...
        print(
            "Inference time: %.5f s / per sample"
